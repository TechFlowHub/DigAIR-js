...
export const respQuestion1 = `"✅ *Quem deve declarar o Imposto de Renda em 2025?*\n
    📌 *Se você teve:*\n
...
export const respQuestion2 = `"🚫 *Quem NÃO precisa declarar o Imposto de Renda em 2025?*\n
    📌 *Você está isento se:*\n
...
export const respQuestion3 = `"💰 *Para que serve o Imposto de Renda e por que ele é cobrado?*\n
...
export const respQuestion4 = `"📌 *O que é IRRF?*\n
...
export const respQuestion5 = `Aqui está o texto ajustado de acordo com a tabela do Imposto de Renda de 2025:\n
    ---\n
    📌 **Tabela do Imposto de Renda 2025**\n
    📊 O cálculo do IRPF é *progressivo*, ou seja, quanto maior a renda, maior o percentual de imposto pago. 🔄💰\n
    📅 Em 2025, a tabela *foi atualizada* com os seguintes valores:\n
    💡 **Quem está isento?**\n
    ...
    ---\n
    Esse texto agora reflete as faixas de renda e os descontos atualizados para 2025. Se precisar de mais ajustes, só avisar!\n`

export const respQuestion6 = `"🏡 *Declarar meu patrimônio vai aumentar meu imposto?*\n
...
export const respQuestion7 = `"📝 *Como declarar o Imposto de Renda?*\n
    ...
    2️⃣ *Preencha os dados*: Preencha informações pessoais, como CPF, RG, endereço, e a sua conta bancária. \n
    3️⃣ *Informe seus rendimentos*: Lembre-se de declarar todos os rendimentos (salário, aluguéis, rendimentos de investimentos).\n
    4️⃣ *Declaração de despesas*: Dependentes, pensão alimentícia, contribuições previdenciárias, entre outros.\n
    ...
    export const respQuestion8 = `"🏠 *Tenho mais de uma casa, preciso declarar todas?*\n
    ...
    🏠 *Atenção!* Mesmo que você não tenha *lucro* ou *renda* com a venda de imóveis, ainda assim é necessário incluí-los na sua declaração.\n
...
export const respQuestion9 = `"🚀 *USE NOSSA IA! 🤖✨*\n
...
export const respQuestion0 = `"👋 *Para finalizar o atendimento*:\n
