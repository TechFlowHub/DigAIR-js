exports.FIRST_MESSAGE = `🟢 Olá! Seja bem-vindo(a) ao Assistente Virtual do Imposto de Renda! 📊💰\n
...
exports.EVALUATION_THANKS = `🌟 *Obrigado pela avaliação!* 🌟\n
Sua opinião é muito importante para nós! 🚀💡\n
Se precisar de mais alguma coisa, estamos à disposição! 😊`

exports.EVALUATION_ERROR = `⚠️ *Opção inválida!* Por favor, escolha uma nota de *1 a 5* para avaliar nosso atendimento.`   